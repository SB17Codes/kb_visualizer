...
const toggleGroupVariants = cva("flex items-center justify-center rounded-md bg-muted p-1", {
  variants: {
    variant: {
      default: "bg-muted",
...
>(({ className, variant, size, children, ...props }, ref) => (
  <ToggleGroupPrimitive.Root className={cn(toggleGroupVariants({ variant, size }), className)} {...props} ref={ref}>
    {children}
